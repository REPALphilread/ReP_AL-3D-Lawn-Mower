void Print_Tip_Setup_Menu() {  
    ...
    if (Angle_Sensor_Enabled == 1) ONOFF1_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, WHITE, GREEN, BLACK, "ON", 2);
    if (Angle_Sensor_Enabled == 0) ONOFF1_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, WHITE, RED, WHITE, "OFF", 2);
    ...
    if (Tip_Over_Sensor_Enabled == 1) ONOFF2_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, WHITE, GREEN, BLACK, "ON", 2);
    if (Tip_Over_Sensor_Enabled == 0) ONOFF2_btn.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, WHITE, RED, WHITE, "OFF", 2);
