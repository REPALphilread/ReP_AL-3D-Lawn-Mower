...
****************************************************************************************************/
  ...
  //Wheel Motors Setup
  byte Max_Cycles                 = 150;                        // Number of loops the Sketch will run before the mower just turns around anyway.
  byte PWM_MaxSpeed_LH            = 240;                        // Straight line speed LH Wheel (Looking from back of mower)
  ...
  int Alarm_1_Hour                = 15;                          // Mowing Hour Number 1
  int Alarm_1_Minute              = 10;                         // Alarm Minute 1
  ...
  byte Alarm_2_Hour               = 18;                         // Mowing Hour Number 2
  byte Alarm_2_Minute             = 23;                         // Alarm minute 2
  ...
  byte Alarm_3_Hour               = 16;                         // Mowing Hour Number 3
  byte Alarm_3_Minute             = 6;                          // Alarm minute 3
  ...
  */
  ...
  // Wire detection Values
    ...
    float P               = 0.095;                                 // Multiplication factor to the error measured to the wire center.  if jerky movement when tracking reduce number
