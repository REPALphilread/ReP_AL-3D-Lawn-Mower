...
- Clean up of the TFT MEGA code and Mower MEGA code. 
- Reduction in used program memory size to allow for more features.
- Improved communication between Mower MEGA and TFT and reduction/elimination of long flashing "Please Wait" sequences.
- Additional features in the WIFI APP to control the Mower sensors remotely via a new tab.  
- Sync feature to give the APP buttons the correct status.
