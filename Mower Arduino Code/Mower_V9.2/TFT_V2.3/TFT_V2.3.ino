...
Adafruit_GFX_Button UP1_BTN, UP2_BTN, UP3_BTN, UP4_BTN, UP5_BTN,
                    DOWN1_BTN, DOWN2_BTN, DOWN3_BTN, DOWN4_BTN, DOWN5_BTN, 
                    OPTION_A_BTN, OPTION_B_BTN, OPTION_C_BTN,
...
if ((Mower_Status_Value == 1) || (Mower_Status_Value ==2)) {
    ...
    while (Menu_Complete_Main == false) {
              ...
              Calculate_TFT_Time();
              Print_Time_TFT();                                                                    // Print the time on the TFT screen
              if (Battery > 8 ) Print_Battery_Graphic();                                           // Print the volts.
              Print_Error_Messages_Docked();                                                       // Print any error messages to the TFT screen which can be fixed e.g. Wire OFF
              Print_Mower_Status();                                                                // Print the mower status to the TFT Screen
          ...
          if ((Mower_Status_Value == 4) || (Mower_Status_Value == 5) || (Mower_Status_Value == 7) || (Mower_Status_Value == 9)) {
