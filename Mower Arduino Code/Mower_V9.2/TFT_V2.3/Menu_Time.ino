...
void Print_Time_Menu() {
    ...
    OPTION1_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, YELLOW, BLACK, YELLOW, "Alarm 1>", 2);
    ...
    OPTION2_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, WHITE, BLACK, WHITE, "Alarm 2>", 2);
    ...
    OPTION3_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, RED, BLACK, WHITE, "Alarm 3>", 2);
    ...
    OPTION4_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, MAGENTA, BLACK, WHITE, "Set Time >", 2);
