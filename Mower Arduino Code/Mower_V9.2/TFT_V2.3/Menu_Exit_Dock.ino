...
void Add_Time_To_Exit_Dock()  {
    ...
    OPTION2_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, BLUE, YELLOW, BLACK, "1hr Mow", 2);
    OPTION2_BTN.drawButton(false);

    //2 hr mow Button  
    Button_X = Button_X;
    Button_Y = Button_Y + (Button_H + Menu_Spacing);   
    OPTION3_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, YELLOW, MAGENTA, YELLOW, "2hr Mow", 2);
    OPTION3_BTN.drawButton(false);

    //Max mow Button  
    Button_X = Button_X;
    Button_Y = Button_Y + (Button_H + Menu_Spacing);    
    OPTION4_BTN.initButton(&tft, Button_X, Button_Y, Button_W, Button_H, YELLOW, RED, YELLOW, "Max Mow", 2);
...
void Sense_Button_Exit_Dock_Time() {
    down = Touch_getXY();
    OPTION2_BTN.press       (down && OPTION2_BTN.contains(pixel_x, pixel_y));       // hr1
    OPTION3_BTN.press       (down && OPTION3_BTN.contains(pixel_x, pixel_y));       // hr2
    OPTION4_BTN.press       (down && OPTION4_BTN.contains(pixel_x, pixel_y));   // Max Mow
