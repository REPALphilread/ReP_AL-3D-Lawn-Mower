...
void Receive_Data_From_TFT()  {
  ...
  if (TFT_Menu_Command == 910) {     
      ...
      DueFlash.write(65, 1);
      DueFlash.write(66, maxdistancesonar); 
      DueFlash.write(63, 1);
      DueFlash.write(64, Max_Sonar_Hit);         
...
// Receive the Battery Values Back again
  if (TFT_Menu_Command == 911) {
      ...
      #if defined(BOARD_DUE)
      DueFlash.write(25, 1);
      DueFlash.write(26, (Battery_Min * 10));   
      DueFlash.write(85, 1);
      DueFlash.write(86, Low_Battery_Instances_Chg); 
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Sensor Menu 1 Values Back again
  if (TFT_Menu_Command == 96) {
      ...
      #if defined(BOARD_DUE)
      DueFlash.write(67 , 1);
      DueFlash.write(68 , Perimeter_Wire_Enabled);
      DueFlash.write(81 , 1);
      DueFlash.write(82 , WIFI_Enabled);
      DueFlash.write(90 , 1);
...
// Receive the Rain Sensor Values Back again
  if (TFT_Menu_Command == 912) {
      ...
      #if defined(BOARD_DUE)
      DueFlash.write(77 , 1);
      DueFlash.write(78 , Rain_Sensor_Installed);
      DueFlash.write(79, 1);
      DueFlash.write(80, Rain_Total_Hits_Go_Home);   
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Mower Motor Values Back again
  if (TFT_Menu_Command == 914) {
      ...
      Serial.println(F(" "));     
       ...
       #if defined(BOARD_DUE)
      DueFlash.write(13, 1);
      DueFlash.write(14, PWM_MaxSpeed_LH);
      DueFlash.write(15, 1);
      DueFlash.write(16, PWM_MaxSpeed_RH);    
      DueFlash.write(94, 1);
      DueFlash.write(95, PWM_Slow_Speed_LH);
      DueFlash.write(96, 1);
      DueFlash.write(97, PWM_Slow_Speed_RH);   
      DueFlash.write(98, 1);
      DueFlash.write(99, ((Slow_Speed_MAG * -1 ) / 10));   
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Mower Motor Values Back again
  if (TFT_Menu_Command == 915) {
      ...
      #if defined(BOARD_DUE)
      DueFlash.write(17, 1);
      DueFlash.write(18, PWM_Blade_Speed);   
      DueFlash.write(83 , 1);
      DueFlash.write(84 , Cutting_Blades_Activate);
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive Movement Values from TFT
  if (TFT_Menu_Command == 916) {
      ...
      //DueFlash
      DueFlash.write(57, 1);
      DueFlash.write(58, (Max_Cycles_Straight / 10));
      DueFlash.write(31, 1);
      DueFlash.write(32, (Mower_Turn_Delay_Min/100));
      DueFlash.write(33, 1);
      DueFlash.write(34, (Mower_Turn_Delay_Max/100));
      DueFlash.write(35, 1);
      DueFlash.write(36, (Mower_Reverse_Delay/100));
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Mower Motor Values Back again
  if (TFT_Menu_Command == 917) {
      ...
      //DueFlash
      DueFlash.write(43, 1);
      DueFlash.write(44, (Track_Wire_Zone_1_Cycles/100));
      DueFlash.write(45, 1);
      DueFlash.write(46, (Track_Wire_Zone_2_Cycles/100));
      DueFlash.write(49 , 1);
      DueFlash.write(50 , CW_Tracking_To_Charge);                
      DueFlash.write(51 , 1);
      DueFlash.write(52 , CCW_Tracking_To_Charge);       
      DueFlash.write(53 , 1);
      DueFlash.write(54 , CW_Tracking_To_Start);                
      DueFlash.write(55 , 1);
      DueFlash.write(56 , CCW_Tracking_To_Start);  
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Mower Motor Values Back again
  if (TFT_Menu_Command == 918) {
      ...
      // DueFlash
      DueFlash.write(69, 1);
      DueFlash.write(70, (Max_Cycle_Wire_Find/10));
      DueFlash.write(71, 1);
      DueFlash.write(72, (Max_Cycle_Wire_Find_Back/10));
      DueFlash.write(27, 1);
      DueFlash.write(28, (Home_Wire_Compass_Heading/10));   
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Charging Station Options
  if (TFT_Menu_Command == 98) {
      ...
      // DueFlash
      DueFlash.write(47 , 1);
      DueFlash.write(48 , Use_Charging_Station);
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive PID Values
  if (TFT_Menu_Command == 919) {
      ...
      // DueFlash
      DueFlash.write(73, 1);
      DueFlash.write(74, (Max_Tracking_Turn_Right/10));
      DueFlash.write(75, 1);
      DueFlash.write(76, (Max_Tracking_Turn_Left/10));
      DueFlash.write(21, 1);
      DueFlash.write(22, (P*100));  
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Compass data from TFT
  if (TFT_Menu_Command == 926) {
      ...
      DueFlash.write(61, 1);
      DueFlash.write(62, (CPower*10)); 
      DueFlash.write(113, 1);
      DueFlash.write(114, Compass_Setup_Mode); 
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the GYRO data from TFT
  if (TFT_Menu_Command == 928) {
      ...
      DueFlash.write(111, 1);
      DueFlash.write(112, (GPower*10)); 
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Time Alarm data from TFT
  if (TFT_Menu_Command == 920) {
      ...
      //DueFlash
      DueFlash.write(1, 1);
      DueFlash.write(2, Alarm_1_Hour);
      DueFlash.write(3, Alarm_1_Minute);
      DueFlash.write(4, Alarm_1_ON);
      DueFlash.write(87, Alarm_1_Action);
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Alarm 2 data from TFT
  if (TFT_Menu_Command == 921) {
      ...
      //DueFlash
      DueFlash.write(5, 1);
      DueFlash.write(6, Alarm_2_Hour);
      DueFlash.write(7, Alarm_2_Minute);
      DueFlash.write(8, Alarm_2_ON);
      DueFlash.write(88, Alarm_2_Action);
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Alarm 3 data from TFT
  if (TFT_Menu_Command == 922) {
      ...
      //DueFlash
      DueFlash.write(9, 1);
      DueFlash.write(10, Alarm_3_Hour);
      DueFlash.write(11, Alarm_3_Minute);
      DueFlash.write(12, Alarm_3_ON);
      DueFlash.write(89, Alarm_3_Action);
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Time data from TFT
  ...
  if (TFT_Menu_Command == 929) {
        ...
        #if defined(BOARD_DUE)
        //DueFlash Saved Values
        DueFlash.write(115, 1);
        DueFlash.write(116, Wheel_Amp_Sensor_ON);
        DueFlash.write(117, 1);
        DueFlash.write(118, Max_Wheel_Amps * 10);
        Serial.println(F("Saved to DueFlash"));
        #endif
  ...
  if (TFT_Menu_Command == 924) {
      ...
      //DueFlash Saved Values
      DueFlash.write(29, 1);
      DueFlash.write(30, Angle_Sensor_Enabled);
      DueFlash.write(92, 1);
      DueFlash.write(93, Tip_Over_Sensor_Enabled);
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Pattern Values Back again
  if (TFT_Menu_Command == 925) {
      ...
      //DueFlash Saved Values
      DueFlash.write(23, 1);
      DueFlash.write(24, Pattern_Mow);
      DueFlash.write(101, 1);
      DueFlash.write(102, Turn_90_Delay_LH / 10);
      DueFlash.write(103, 1);
      DueFlash.write(104, Turn_90_Delay_RH / 10);
      DueFlash.write(105, 1);
      DueFlash.write(106, Line_Length_Cycles / 10);
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Navigation data from TFT
  if (TFT_Menu_Command == 930) {
      ...
      #if defined(BOARD_DUE)
      // DueFlash
      DueFlash.write(119 , 1);
      DueFlash.write(120, PCB);      
      Serial.println(F("Saved to DueFlash"));
      #endif
...
// Receive the Navigation data from TFT
  if (TFT_Menu_Command == 299) {
      ...
      // DueFlash
      DueFlash.write(99 , 1);
      DueFlash.write(100, GPS_Enabled);     
      Serial.println(F("Saved to DueFlash"));
      #endif
